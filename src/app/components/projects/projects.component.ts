...
import {
  Project,
  ProjectRowComponent,
} from './project-row/project-row.component';
...
export class ProjectsComponent {
  projects: Project[] = [
    {
      title: 'Nostr-AI-damus',
      description: `This was my project for my graduation assignment at the Hogeschool van Amsterdam. I did the project in collaboration with the company Spicelab.
       The goal was to create a prediction model that could predict when customers would need certain products based on their previous purchases.
       I used a combination of machine learning techniques and data analysis to build the model, and I was able to achieve a high level of accuracy in my predictions.
       The project was a great learning experience for me, and I am proud of the work I accomplished.`,
      urls: [],
    ...
    },
    {
      ...
      urls: [
        {
          url: 'https://github.com/ItsBartHermans/Portfolio-25',
